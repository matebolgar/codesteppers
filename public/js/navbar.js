(() => {
  ...
  function render() {
    if (isMainCollapsed) {
      ...
      document.getElementById("main-navbar-items").classList.remove("fade-in");
    } else {
      document.getElementById("main-navbar-items").classList.add("fade-in");
    ...
    if (isSubscriberCollapsed) {
      ...
      document.getElementById("subscriber-navbar-items").classList.remove("fade-in");
    } else {
      document.getElementById("subscriber-navbar-items").classList.add("fade-in");

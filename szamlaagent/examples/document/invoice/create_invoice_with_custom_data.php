<?php
    ...
    try {
        ...
        $header->setFulfillment('2020-12-04');
        // Számla fizetési határideje
        $header->setPaymentDue('2020-12-04');
        ...
        $buyerLedger = new BuyerLedger('123456', '2020-05-01', '123456', true);
        // Számla elszámolási időszak kezdete (folyamatos teljesítés esetén)
        $buyerLedger->setSettlementPeriodStart('2020-04-01');
        // Számla elszámolási időszak vége (folyamatos teljesítés esetén)
        $buyerLedger->setSettlementPeriodEnd('2020-04-30');
        ...
        $itemLedger->setSettlementPeriodStart('2020-04-01');
        // Tétel elszámolási időszak vége
        $itemLedger->setSettlementPeriodEnd('2020-04-30');
